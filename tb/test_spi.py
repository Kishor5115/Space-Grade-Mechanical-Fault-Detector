...
# System clock period. Signed-off macro target is 16 MHz (62.5 ns) --
# see librelane/signoff_constraints.sdc / README.md Target Technology
# Configuration. Kept in its own constant so gate-level (SDF-backannotated)
# runs exercise the real signoff period rather than a looser placeholder.
CLK_NS = 62.5
